...
boxEl.addEventListener('click', function () {
  ...
  const spanEls = document.querySelectorAll('span');  //span 태그를 불러옴
  console.log(spanEls);
  ...
  const hasActive = boxEl.classList.contains('active'); // 요소에 active라는 클래스 값이 있는지 확인
